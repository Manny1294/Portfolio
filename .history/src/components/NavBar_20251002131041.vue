...
<template>
  <BNavbar toggleable="lg" fixed="top" class="py-3 nav-bar">
    <BContainer class="d-flex align-items-center justify-content-between mb-3">
      <!-- Logo -->
      <BNavbarBrand>
      ...
      <BNavbarNav class="d-none d-lg-flex">
        ...
        <BNavItem
          ><a href="#service" class="nav-link" exact-active-class="active">Services</a></BNavItem
        >
        <BNavItem
          ><a href="#projects" class="nav-link" exact-active-class="active">Projects</a></BNavItem
        >
        <BNavItem
  ...
  <transition name="slide-overlay">
    <div v-if="isMenuOpen" class="mobile-overlay">
      ...
      <nav class="overlay-nav-links">
        ...
        <a href="#service" class="overlay-link" @click="closeMenu">Services</a>
        <a href="#projects" class="overlay-link" @click="closeMenu">Projects</a>
